...
- [문제5 - 그룹 애너그램](https://leetcode.com/problems/group-anagrams/)
- [문제6 - 가장 긴 팰린드롬 부분 문자열](https://leetcode.com/problems/longest-palindromic-substring/description/)

## 2. 배열
- [문제7 - 두 수의 합](https://leetcode.com/problems/two-sum/description/)
- [문제8 - 빗물 트래핑](https://leetcode.com/problems/trapping-rain-water/)
- [문제9 - 세 수의 합](https://leetcode.com/problems/3sum/)
- [문제10 - 배열 파티션1](https://leetcode.com/problems/array-partition/description/)
- [문제11 - 자신을 제외한 배열의 곱](https://leetcode.com/problems/product-of-array-except-self/description/)
- [문제12 - 주식을 사고팔기 가장 좋은 시점](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/description/)

## 3. 연결 리스트
- [문제13 - 팰린드롬 연결 리스트](https://leetcode.com/problems/palindrome-linked-list/description/)
- [문제14 - 두 정렬 리스트의 병합](https://leetcode.com/problems/merge-two-sorted-lists/description/)
- [문제15 - 역순 연결 리스트](https://leetcode.com/problems/reverse-linked-list/description/)
- [문제16 - 두 수의 덧셈](https://leetcode.com/problems/add-two-numbers/description/)
- [문제17 - 페어의 노드 스왑](https://leetcode.com/problems/swap-nodes-in-pairs/description/)
...
- [문제23 - 큐를 이용한 스택 구현](https://leetcode.com/problems/implement-stack-using-queues/description/)
...
- [문제38 - 조합](https://leetcode.com/problems/combinations/)
- [문제39 - 조합의 합](https://leetcode.com/problems/combination-sum/)
- [문제40 - 부분집합](https://leetcode.com/problems/subsets/description/)
- [문제41 - 일정 재구성](https://leetcode.com/problems/reconstruct-itinerary/)
